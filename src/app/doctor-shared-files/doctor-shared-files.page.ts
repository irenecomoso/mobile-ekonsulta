...
@Component({
  selector: 'app-doctor-shared-files',
  templateUrl: './doctor-shared-files.page.html',
  styleUrls: ['./doctor-shared-files.page.scss'],
})
export class DoctorSharedFilesPage implements OnInit {
